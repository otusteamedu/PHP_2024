...
2. **Интеграционные тесты**
    ...
    2. **Связка бэк - БД в части генерации Order_number и Sum**
        1. Проверить соответствие значения Sum данным прейскуранта (таблица в БД) с учётом возможных скидок
        2. В зависимости от логики обработки заказа проверить, что сделана запись в БД для Order_number и Sum
    ...
    4. **Связка сервис А/бэк - репозиторий - БД**
