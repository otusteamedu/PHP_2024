...
(
    ...
    CONSTRAINT `tickets_ibfk_2` FOREIGN KEY (`ticket_price_id`) REFERENCES `ticket_prices` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
...
(
    ...
    KEY          `session_id` (`session_id`),
    KEY          `seat_id` (`seat_id`),
    CONSTRAINT `ticket_prices_ibfk_1` FOREIGN KEY (`session_id`) REFERENCES `sessions` (`id`),
    CONSTRAINT `ticket_prices_ibfk_2` FOREIGN KEY (`seat_id`) REFERENCES `seats` (`id`)
