...
#[AsCommand(name: self::COMMAND_NAME, description: 'Delete web-hook', hidden: true)]
class DeleteWebHook extends Command
{
    public const COMMAND_NAME = 'web-hook:delete';
    ...
    {
        $response =  $this->telegramApi->removeWebhook();
