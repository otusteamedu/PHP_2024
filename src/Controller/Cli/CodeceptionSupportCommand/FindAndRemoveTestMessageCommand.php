...
#[AsCommand(name: self::COMMAND_NAME, description: 'Find and remove acceptance test message', hidden: true)]
class FindAndRemoveTestMessageCommand extends AbstractCodeceptionSupportCommand
{
