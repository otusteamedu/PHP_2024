...
final class Version20240516144954 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE playlist (id INT NOT NULL, "user" VARCHAR(60) NOT NULL, name VARCHAR(60) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE track (id INT NOT NULL, author VARCHAR(60) NOT NULL, genre VARCHAR(60) NOT NULL, duration INT NOT NULL, PRIMARY KEY(id))');
