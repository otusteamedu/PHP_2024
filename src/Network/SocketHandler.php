...
use Dsmolyaninov\Hw5\Core\ConfigReader;
use Socket;
...
class SocketHandler
{
    public function getSocketPath(): string
    {
        ...
        $socketPath = $configReader->getValue('SOCKET_PATH');
        if (empty($socketPath)) {
            throw new \RuntimeException("Путь к сокету не определен в конфигурации.");
        }
        return $socketPath;
    }
