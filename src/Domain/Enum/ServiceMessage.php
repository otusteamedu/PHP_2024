...
{
    case Default              = "Для запуска приложения введите корректную команду\n";
    ...
    case ClientStarted        = "[Client] Client started \n";
    ...
    case ProductLoadSuccess   = "\nУспешно: в базу загружено продуктов в количестве ";
    ...
    case QuerySelectSuccess   = "\nУспешно: найдено ";
    case QuerySelectError     = "\nОшибка: ничего не найдено";
}
