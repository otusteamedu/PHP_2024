...
DEPLOY_PATH="/var/docker/cicd_practice/releases"
CURRENT_PATH="/var/docker/cicd_practice/current"
PREVIOUS_PATH="/var/docker/cicd_practice/previous"
#NGINX_CONFIG_PATH="/var/www/cicd_practice/current/infra/nginx/default"  # Путь к конфигу Nginx в проекте
...
git clone git@gitlab.com:AlexAgapitov/cicd_practice.git $NEW_RELEASE_PATH
