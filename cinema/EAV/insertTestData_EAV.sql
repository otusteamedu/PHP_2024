...
insert into attributes(name, typeId) values
  ('рецензия критика', 5),
  ('отзыв неизвестной киноакадемии', 5),
  ('оскар', 1),
  ('ника', 1),
  ('мировая премьера', 4),
  ('премьера в РФ', 4),
...
insert into movie_attributes(movieId, attributeId, value_varchar) values
...
insert into movie_attributes(movieId, attributeId, value_boolean) values
  (1, 3, true),
  (2, 4, false);

insert into movie_attributes(movieId, attributeId, value_date) values
  (1, 5, '2001-04-22'),
  (2, 6, '2004-08-19'),
  (1, 7, '2024-08-05'),
  (1, 8, '2024-08-25'),
