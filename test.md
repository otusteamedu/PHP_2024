...
3. Если order_number содержит более 16 символов, то тестируемый метод возвращает 400 с сообщением об ошибке.
4. Если card_expiration имеет неверный формат "мм/гг" или указывает на прошедшую дату, то тестируемый метод возвращает
   400 с
   сообщением об ошибке.
5. Если cvv содержит не 3 цифры, то тестируемый метод возвращает 400 с сообщением об ошибке.
