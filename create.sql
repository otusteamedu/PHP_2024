...
(
    ...
    PRIMARY KEY(`id`),
    INDEX `fk_halls_session_idx`(`halls_id` ASC) VISIBLE,
    INDEX `fk_movies_session_idx`(`movie_id` ASC) VISIBLE,
    UNIQUE INDEX `unq_session`(`halls_id` ASC, `movie_id` ASC, `start_time` ASC) VISIBLE,
...
(
    ...
    INDEX `fk_tickets_price_category_idx`(`price_category_id` ASC) VISIBLE,
    INDEX `fk_tickets_seats_idx`(`seat_id` ASC) VISIBLE,
    CONSTRAINT `fk_tickets_session`
    FOREIGN KEY(`session_id`)
    REFERENCES `cinema`.`movies_sessions`(`id`),
