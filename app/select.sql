...
INSERT INTO attribute_types (id, name) VALUES
                                           (1, 'string'), (2, 'int'), (3, 'text'), (4, 'bool'), (5, 'date'), (6, 'float');
INSERT INTO attributes (id, name, type_id, is_system) VALUES
                                                          (1, 'premiere', 5, false),
                                                          (2, 'description', 3, false),
                                                          (3, 'genre', 1, false),
                                                          (4, 'ticket_sale_start', 5, true),
                                                          (5, 'tv_ad_start', 5, true);
...
AS SELECT films.id AS film_id, attributes.name AS attribute,
    ...
    WHERE attributes.is_system = true;
...
WHERE attribute_values.film_id = films.id AND attributes.is_system = false