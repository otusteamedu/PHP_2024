...
-- Для фильма Начало
INSERT INTO attribute_values (movie_id, attribute_id, value_text, value_boolean, value_date, value_float)
VALUES (1, 1,
       ...
       (1, 3, NULL, NULL, '2020-07-16', NULL),
       (1, 4, NULL, NULL, NULL, 829.9),
       (1, 5, NULL, NULL, '2020-06-01', NULL),
       (1, 6, NULL, NULL, '2020-05-15', NULL);
...
VALUES (2, 1,
        ...
        NULL, NULL, NULL),
       (2, 2, NULL, TRUE, NULL, NULL),
       (2, 3, NULL, NULL, '2021-12-19', NULL),
       (2, 4, NULL, NULL, NULL, 2187.5),
       (2, 5, NULL, NULL, '2021-11-01', NULL),
       (2, 6, NULL, NULL, '2021-10-20', NULL);
...
VALUES (3, 1,
       ...
       (3, 3, NULL, NULL, '2023-11-07', NULL),
       (3, 4, NULL, NULL, NULL, 677.5),
       (3, 5, NULL, NULL, '2023-09-25', NULL),
       (3, 6, NULL, NULL, '2023-09-10', NULL);
...
VALUES (4, 1,
        ...
        NULL, NULL, NULL),
       (4, 2, NULL, TRUE, NULL, NULL),
       (4, 3, NULL, NULL, '2024-03-31', NULL),
       (4, 4, NULL, NULL, NULL, 466.3),
       (4, 5, NULL, NULL, '2024-02-10', NULL),
       (4, 6, NULL, NULL, '2024-01-25', NULL);
