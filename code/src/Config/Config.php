...
namespace Viking311\DbPattern\Config;
...
class Config
{
    ...
    public function __construct()
    {
        ...
        if (!array_key_exists('host', $postgresCfg)) {
            throw new ConfigException('host parameter
             not found in app.ini file');
        }
