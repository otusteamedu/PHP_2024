...
class Router
{
    private static array $routes = [
        ...
        '/news/by/id/' => [\Controllers\Start::class, 'newsById'],
        '/news/' => [\Controllers\Start::class, 'news'],
        '/news/set/' => [\Controllers\Start::class, 'set'],
        '/news/subscribe/' => [\Controllers\Start::class, 'subscribe'],
        '/post/setNews' => [\Controllers\Start::class, 'post_setNews'],
        '/post/subscribe' => [\Controllers\Start::class, 'post_subscribe'],
    ];
